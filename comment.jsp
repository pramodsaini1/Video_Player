                ...
                String vcode = request.getParameter("vcode");
                        ...
                        if(ps.executeUpdate()>0){
                            ...
                            String pp = "black";
                                ...
                                ResultSet rss = sts.executeQuery("select * from commentlike where code='" +code+ "' AND email='" + email + "' AND ptr='like'");
                                if (rss.next()) {
                                    pp = "blue";
                                }
                                String pp1 = "black";
                                ...
                                ResultSet rss1 = sts1.executeQuery("select * from commentlike where code='" +code+"' AND email='" + email + "' AND ptr='dislike'");
                                if (rss1.next()) {
                                    pp1 = "blue";
                                }
                            String col = "";
                                ...
                                ResultSet rs17 = st17.executeQuery("select * from commentlike where code='" +code+ "' AND email='" + email + "'");
                                if (rs17.next()) {
                            ...
                            String cmt_like = "";
                                ...
                                ResultSet rs14 = st14.executeQuery("select  count(*) from commentlike where code='"+code+"' AND ptr='like'");
                                if (rs14.next()) {
                                    cmt_like = rs14.getString(1);
                                }
                                String cmt_dislike = "";
                                Statement st16 = cn.createStatement();
                                ResultSet rs16 = st16.executeQuery("select  count(*) from commentlike where code='"+code+"' AND ptr='dislike'");
                                if (rs16.next()) {
                             ...
                             %>
                              <div class="col-sm-12" >
                                                <div class="card">
                                                    <div clas="card-header"><img src="profile/<%out.print(rs.getString("code"));%>.jpg" style="widht:30px;height:50px;" class="img-fluid rounded-circle"><strong><%=rs.getString("username")%></strong> </div>
                                                    <div class="card-body">
