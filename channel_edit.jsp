<%-- 
    Document   : channel_edit
    Created on : 26 Feb, 2022, 9:29:26 AM
    Author     : Genius
--%>
       ...
       <div class="col-sm-8 w3-card">	   
           <%
             try{
                 ...
                 if(rs.next()){
                     %>
                     <form method="post" action="update_channel.jsp?code=<%=code%>">
                         <label><strong>Channel Name:</strong></label>
                         <input type="text" name="cname" class="form-control"  value="<%out.print(rs.getString("cname"));%>" required><br><br>
