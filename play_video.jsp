	  ...
	  <script>
	   ...
	   $(document).ready(function(){
               $(".btn.btn-success").click(function(){
                ...
                $(".dislike").click(function(){
                  ...
                  $(".btn.btn-danger").click(function(){
                    var code=$(this).attr("rel");
                     $.post(
                       "subscibe.jsp",{code:code},function(data){
                         var subs= data.trim();
           ...
           $(document).on("click",".cmt1",function(){
             ...
             $.post(
                 "cmt_like.jsp",{code:code,ptr:ptr},function(data){
                           var dt = data.split("-");
            ...
            $(document).on("click",".cmt2",function(){
             ...
             var ptr = $(this).attr("ptr");
             $.post(
                 "cmt_dislike.jsp",{code:code,ptr:ptr},function(data){
                           var dt = data.split("-");
            ...
            $(document).on("click",".fa.fa-edit",function(){
             ...
             $(document).on("click",".fa.fa-save",function(){
               ...
               var msg   = $("#d"+code).val();
                $.post(
                    "update_cmt.jsp",{code:code,msg:msg},function(data){
            ...
            $(document).on("click",".fa.fa-trash",function(){
               ...
               $.post(
                    ...
                    "delete_cmt.jsp",{code:code},function(data){
                       if(data.trim()=="success"){
                           $("#d-"+code).fadeOut(1000);
                       }
                    }
  ...
  <div class="row" >
      <div class="col-sm-8 w3-card" id="fav">
           <%
             try{
                 ...
                 if(rs.next()){
                     ...
                     %>
                     <video class="card-img-top" controls="controls" autoplay muted style="max-width: 100%; height: auto;" poster="profile/<%out.print(rs.getString("code"));%>.jpg"  class="img-fluid"  >
                      ...
                      <div class="col-sm-12">
                         <%
                          ...
                          String like="";
                                ...
                                ResultSet rs10 = st10.executeQuery("select  * from favorite where email='"+email+"' AND code='"+code+"'");
                                if(rs10.next()){
                               ...
                               Statement stv =cn.createStatement(); 
                                ...
                                ResultSet rsv2 = stv2.executeQuery("select  * from favorite where email='"+email+"' AND code='"+code+"' AND color='red'");
                                if(rsv2.next()){
                                    fv="red" ;
                                }
                          ...
                          <table class="table table-borderless">
                              <tr>
                                  <td data-aos="fade-right"><h3><strong><%=rs.getString("title")%></strong></h3></td> <td data-aos="fade-right" style="float:right;"><i  id="fav-<%=rs.getString("code")%>" rel="<%=rs.getString("code")%>" class="fa fa-star"  style="font-size:24px;color:<%=fv%>;"></i><strong>Add to favorite</strong></td>
                              </tr>
                              <tr>
                                  <td data-aos="fade-right"><h5><strong><%=rs.getString("dt")%></strong></h5></td> <td data-aos="fade-right" style="float:right;"> <i class="fa fa-thumbs-up like" style="color:<%=cv%>;cursor:pointer;" pid="like" id="like-<%=code%>"  rel="<%=code%>"></i><span id="likecount-<%=code%>"><%=like%></span>
                                  </td><td data-aos="fade-right"><i class="fa fa-thumbs-down dislike" style="color:<%=cv1%>;cursor:pointer;" pid="dislike" id="dislike-<%=rs.getString("code")%>" rel="<%=rs.getString("code")%>"> </i><span id="dislikecount-<%=code%>"><%=dislike%></span></td><td data-aos="fade-right"><i class="fa fa-eye"><%=vi%></i></td>
                              </tr>
                          </table> 
                      ...
                      <div class="col-sm-12">
                          <%
                            ...
                            try{
                                Class.forName("com.mysql.jdbc.Driver");
                                Connection cnm=DriverManager.getConnection("jdbc:mysql://localhost:3306/video","root","");
                                ...
                                if(rsm.next()){
                                    ...
                                    <table class="table table-borderless">
                                        <tr>
                                            <td data-aos="fade-right"><img style="height:50px;height:50px;" src="profile/<%=rsm.getString("code")%>.jpg" class="img-fluid"></td><td data-aos="fade-right"><h3><strong><%=rsm.getString("cname")%></strong></h3></td><td data-aos="fade-right"><strong>(<%=rsm.getString("category")%>)</strong></td><td  data-aos="fade-right" style="float:right;"> <button  class="btn btn-danger" style="background-color:<%=ch%>;color:white;" id="sub-<%=rsm.getString("code")%>" rel="<%=rsm.getString("code")%>"><%=cb%></button><i style="font-size: 25px;color:black;" id="bell-<%=rsm.getString("code")%>" class="fa fa-bell" ></i></td>
                                        </tr>
                                          
                                    </table>
                                        <table class="table table-borderless">
                                         <tr>
                                            <td data-aos="fade-right"><h5><strong><%=rs.getString("description")%></strong></h5></td>
                                        </tr>
                                         </table>
                                         <script>
                                            $(document).ready(function(){
                                               ...
                                               if(color=="green"){
                                                    ...
                                                    $("#sub-"+cc).css("background-color","red");
                                                    $("#sub-"+cc).css("color","white");
                               ...
                               try{
                                   ...
                                   while(rs12.next()){
                                        ...
                                        String cmt_code=rs12.getString("code");
                                            ...
                                            ResultSet rs14 = st14.executeQuery("select  count(*) from commentlike where code='"+cmt_code+"' AND ptr='like'");
                                            if(rs14.next()){
                                                cmt_like =rs14.getString(1);
                                            }
                                            String cmt_dislike="";
                                            Statement st16 =cn.createStatement(); 
                                            ResultSet rs16 = st16.executeQuery("select  count(*) from commentlike where code='"+cmt_code+"' AND ptr='dislike'");
                                            if(rs16.next()){
                                            ...
                                            ResultSet rs17 = st17.executeQuery("select * from commentlike where code='"+cmt_code+"' AND email='"+email+"'");
                                            if(rs17.next()){
                                            ...
                                            ResultSet rss = sts.executeQuery("select * from commentlike where code='"+cmt_code+"' AND email='"+email+"' AND ptr='like'");
                                            if(rss.next()){
                                                 pp ="blue";
                                            }
                                            String pp1="black";
                                            ...
                                            ResultSet rss1 = sts1.executeQuery("select * from commentlike where code='"+cmt_code+"' AND email='"+email+"' AND ptr='dislike'");
                                            if(rss1.next()){
                                                 pp1 ="blue";
                                            }
                                        ...
                                        ResultSet rs13 = st13.executeQuery("select * from admin where email='"+ema+"'");
                                        if(rs13.next()){
                                            cpp=rs13.getString("code");
                                        }
                                        String cpp1="";
                                            Statement spp=cn.createStatement();
                                        ResultSet rpp = spp.executeQuery("select * from admin where email='"+ema+"'");
                                        if(rpp.next()){
                                            cpp1=rpp.getString("username");
                                        }
                                            ...
                                            <div class="col-sm-12" id="d-<%=rs12.getString("code")%>">
                                                <div class="card">
                                                    <div clas="card-header"><img src="profile/<%=cpp%>.jpg" style="widht:30px;height:50px;" class="img-fluid rounded-circle"><strong><%=cpp1%></strong><i style="float:right;font-size: 25px;"  ></i> </div>
                                                    <div class="card-body"  >
       ...
       <div class="col-sm-4 w3-card">
           <center><h2 style="color:blue;" class="w3-card w3-blue"><strong>Related Videos</strong></h2></center>
           <%
               ...
               try{
                   ...
                   while(rs1.next()){
                       ...
                       %>
                       <table class="table table-borderless w3-card-4 " data-aos="fade-up"id="pk" >
                                      <tr>
                                        <td align="center"><a href="play_video.jsp?code=<%=rs1.getString("code")%>&ccode=<%=rs1.getString("ccode")%>"><img data-aos="fade-right" src="profile/<%=rs1.getString("code")%>.jpg" class="img-fluid"></a></td>
                                       </tr>
                                       <tr>
...
<footer class="footer">
            <div class="container-fluid" style="background-color:graytext;">
                        <div>
