<%-- 
    Document   : liked_video
    Created on : 13 Mar, 2022, 5:57:03 PM
    Author     : Genius
--%>
...
<div class="container-fluid">
               <h3 class="w3-card w3-blue"><strong><center>Liked Videos</center></strong></h3>
  <div class="row" >
      <%
             ...
             if(rs2.next()){
                 ...
                 <div class="col-sm-4 w3-card video-block">
                              <table class="table table-borderless">
                                  ...
                                  <tr>
                                      <td><strong><%=rs2.getString("title")%></strong></td><td><i style="float:right;color:blue;" class="fa fa-thumbs-up"></i></td>
                                  </tr>
                              </table>
