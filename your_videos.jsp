<%-- 
    Document   : your_videos
    Created on : 17 Mar, 2022, 10:58:04 AM
    Author     : Genius
--%>
...
<div class="container-fluid">
               <h3 class="w3-card w3-blue"><strong><center>your Videos</center></strong></h3>
  <div class="row" >
      <%
         Statement st1 = cn.createStatement();
         ResultSet rs1 = st1.executeQuery("select * from video  where email='"+email+"' order by rand() ");
         while(rs1.next()){
                 ...
                 <div class="col-sm-4 w3-card video-block">
                              <table class="table table-borderless">
                                  <tr>
                                      <td><a href="play_video.jsp?code=<%=rs1.getString("code")%>&ccode=<%=rs1.getString("ccode")%>"><img src="profile/<%=rs1.getString("code")%>.jpg" class="img-fluid"></a></td>
                                  </tr>
                                  <tr>
                                      <td><strong><%=rs1.getString("title")%></strong></td> 
                                  </tr>
                              </table>
