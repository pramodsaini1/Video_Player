...
<div class="container-fluid">
    <%
       try{
           ...
           Connection cb = DriverManager.getConnection("jdbc:mysql://localhost:3306/video","root","");
           Statement sb = cb.createStatement();
           ResultSet rb = sb.executeQuery("select * from channel where code='"+code+"' AND status=0");
           if(rb.next()){
               cccode = rb.getString("code");
               %>
                 <h3><strong><center><%=rb.getString("cname")%></center></strong></h3>
