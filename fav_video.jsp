<%-- 
    Document   : fav_video
    Created on : 12 Mar, 2022, 5:12:04 PM
    Author     : Genius
--%>
...
<div class="container-fluid">
               <h3 class="w3-card w3-blue"><strong><center>Favorite Videos</center></strong></h3>
  <div class="row" >
      <%
         Statement st1 = cn.createStatement();
         ResultSet rs1 = st1.executeQuery("select * from favorite  where email='"+email+"' order by rand()");
         while(rs1.next()){
             ...
             if(rs2.next()){
                 ...
                 <div class="col-sm-4 w3-card video-block">
                              <table class="table table-borderless">
                                  ...
                                  <tr>
                                      <td><strong><%=rs2.getString("title")%></strong></td><td><i style="float:right;color:red;" class="fa fa-heart"></i></td>
                                  </tr>
                              </table>
