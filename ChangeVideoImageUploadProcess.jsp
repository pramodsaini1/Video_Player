<%-- 
    Document   : ChangeVideoImageUploadProcess
    Created on : 27 Feb, 2022, 3:42:46 PM
    Author     : Genius
--%>
...
if(request.getParameter("code")==null&&request.getParameter("ccode")==null){
    response.sendRedirect("dashboard.jsp?code_error=1");
        ...
        fileOut.flush();
        fileOut.close();
        response.sendRedirect("All_channel_video.jsp?code="+ccode+"&success=1");
        }catch (Exception e)
        {

        response.sendRedirect("All_channel_video.jsp?code="+ccode+"&video_img_err=1");
        }
        }
}
