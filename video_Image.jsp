<%-- 
    Document   : video_Image
    Created on : 26 Feb, 2022, 11:38:31 AM
    Author     : Genius
--%>
...
<div class="container-fluid">
  <div class="row" >
       ...
       <div class="col-sm-8 w3-card">
           <h3><strong><center>Add Video Image</center></strong></h3>
		 <form method="post" ACTION="VideoImageUploadProcess.jsp?code=<%=code%>" name="uploadForm" ENCTYPE='multipart/form-data'>
